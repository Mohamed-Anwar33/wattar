...
const HeroSection = () => {
  ...
  return <section
      ...
      className="relative min-h-[80vh] md:min-h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-24 scroll-mt-20 md:scroll-mt-24">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 hero-spotlight hidden sm:block"
        style={{
      ...
      <div className="hidden md:block absolute top-10 left-10 w-32 h-32 opacity-20 animate-float">
        <img src={abstractElements} alt="" className="w-full h-full object-contain" />
      </div>
      <div className="hidden md:block absolute bottom-20 right-20 w-24 h-24 opacity-30 animate-float" style={{
      animationDelay: '2s'
    }}>
        <div className="w-full h-full bg-gradient-primary rounded-full blur-xl"></div>
      </div>
      <div className="hidden md:block absolute top-1/3 right-10 w-16 h-16 opacity-25 animate-float" style={{
      animationDelay: '1s'
    }}>
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
          {/* Left Illustration */}
          <div className="order-2 md:order-2 mx-auto w-full max-w-[560px] md:max-w-[720px] lg:max-w-[840px] xl:max-w-[900px] animate-fade-in">
            <div
              ref={cardRef}
              onMouseMove={handleCardMouseMove}
              onMouseLeave={handleCardLeave}
              className="tilt-card relative aspect-[16/10] md:aspect-video rounded-[28px] md:rounded-[48px] bg-white/80 md:bg-white/95 shadow-2xl p-2 md:p-4 overflow-hidden">
              <div className="absolute inset-0 -z-10">
                <div className="absolute -left-10 -top-12 w-[140%] aspect-[1.6] rounded-full bg-[#061f23] dark:bg-transparent"></div>
              </div>
              <div className="relative h-full w-full rounded-[22px] md:rounded-[36px]">
                <DotLottieReact
              ...
              <div aria-hidden className="pointer-events-none absolute inset-0 rounded-[28px] md:rounded-[48px] bg-gradient-to-b from-white/20 via-transparent to-transparent mix-blend-overlay" />
            </div>
          </div>
          ...
          <div className="order-1 md:order-1 md:pl-6 animate-slide-up" dir="rtl">
            <div className="relative ml-auto max-w-[560px] px-3 sm:px-0">
              ...
              <div className="relative text-right text-slate-900 dark:text-slate-100">
                ...
                <h2 className="text-4xl md:text-6xl font-extrabold leading-[1.24] md:leading-[1.18] text-[#008080] dark:text-teal-300 drop-shadow-[0_6px_20px_rgba(255,235,59,0.5)] gradient-stroke">
                  صناعة الأثر الرقمي
                </h2>
                <div
                  aria-hidden
      ...
      {/* Decorative Elements */}
      <div className="hidden md:block absolute -bottom-20 -left-20 w-96 h-96 bg-gradient-primary rounded-full blur-3xl opacity-10"></div>
      <div className="hidden md:block absolute -top-20 -right-20 w-80 h-80 bg-gradient-secondary rounded-full blur-3xl opacity-10"></div>
    </section>;
};
